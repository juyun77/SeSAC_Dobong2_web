...
addEvenetListener(동작의 종류, function(){})
...
input.addEventListener('keydown',function(event){
    ...
    // console.log(event.keyCode)//이거는 잘 안씀 잊어도 됨
    if(event.code==="ArrowLeft")
    {
        console.log("왼쪽 방향키가 눌렸습니다.")
    }
    else if(event.code==="ArrowRight")
        {
            console.log("오른쪽 방향키가 눌렸습니다.")
        }
...
window.addEventListener('scroll',(event)=>{
    console.log(event)
    console.log(scrollY)
 //scrollY 1085에서 div opacity가 1이 되도록
 if(scrollY>1085){

...
const helloWorld3 = function(){console.log('hello world 3')}
helloWorld3()

//화살표 함수
//helloWorld4() , err! 선언되기 전에 호출 불가능
const helloWorld4 = () => {console.log('hello world 4')}
helloWorld4()
...
console.log(sayHello2("안녕","juyun"))

//3. 매개변수 2개, 함수 표현식
//내부 스코프 console.log작성
...
const sayHelloValue = sayHello4("안녕","juyun")
console.log(sayHelloValue)


function multifly(a1,a2){
    return a1*a2;
}
console.log(multifly(3,7))
console.log(multifly(2,2))

const square= function (a1){
    console.log(a1**2);
}
square(4)
square(11)

...
//문자와 변수를 동시에 써보기
 ...
 console.log(aaaa)
 console.log('내 이름은'+ myName) //더하기 기호 사이에는 띄어쓰기가 없다.
...
console.log(` ${typeof 100} isn\'t  ${typeof "문자"} data type`)
...
//parseInt : 정수로 바꿔줌
console.log(parseInt(n2))  //"123.5" > 123 (소수점 버려짐)

// let english = Number (prompt("영어 점수를 입력해주세요"))
